...
// This is the json data to be loaded on the page
const teamNames = [
...
//This functions registers the title for the page
function Welcome() {
  return (<h1>A react app for March Madness Basketball!</h1>);
}

//This functions has some basic info about the page
function Info() {
  return (
  <p>
    This is the website to come to for March Madness! Look at the teams and their basic information to make your predictions!
  </p>
  );
}

//This creates a component for each of the teams and loads in their data from the json
...
//This lists out all the team components and their corresponding data
function TeamList() {
  return (
    <div>
...
//This calls the functions within the app, including loading a header, some basic information, and the TeamList
function App() {
  return (
    <div className="App">
